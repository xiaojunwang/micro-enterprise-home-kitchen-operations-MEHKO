...
function (_Component) {
  ...
  Item_createClass(Item, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement("a", null, " ", item.image && external_react_default.a.createElement("img", {
        src: item.image,
        alt: item.title
      ...
      }, external_react_default.a.createElement("a", null, "Edit")), external_react_default.a.createElement(AddToCart["b" /* default */], {
        id: item.id
...
var Pagination_Pagination = function Pagination(props) {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    }, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "MEHKO - Page ", page, " of ", pages)), external_react_default.a.createElement(link_default.a, {
      prefetch: true,
      href: {
        pathname: 'items',
        query: {
