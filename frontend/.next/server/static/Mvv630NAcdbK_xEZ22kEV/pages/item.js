...
var H2Underline = external_styled_components_default.a.h2.withConfig({
  displayName: "SingleItem__H2Underline",
  componentId: "sc-1v1tzsb-1"
})(["text-decoration:underline;"]);
var DescUnderline = external_styled_components_default.a.h3.withConfig({
  ...
  _createClass(SingleItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        var item = data.item;
        return external_react_default.a.createElement(SingleItemStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "MEHKO | ", item.title)), external_react_default.a.createElement("img", {
          src: item.largeImage,
          alt: item.title
        }), external_react_default.a.createElement("div", {
          className: "details"
        }, external_react_default.a.createElement(H2Underline, null, item.title), external_react_default.a.createElement("p", null, "Crafted and Sold by ", external_react_default.a.createElement("em", null, item.user.name)), external_react_default.a.createElement(DescUnderline, null, item.description), external_react_default.a.createElement("p", null, "Price - ", Object(formatMoney["a" /* default */])(item.price)), external_react_default.a.createElement("div", {
          className: "addToCart"
        }, external_react_default.a.createElement(AddToCart["b" /* default */], {
          id: item.id
        }))));
      });
    }
