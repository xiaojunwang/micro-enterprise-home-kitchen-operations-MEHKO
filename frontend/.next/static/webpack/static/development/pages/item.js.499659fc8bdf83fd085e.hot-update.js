...
})(["border-radius:50px;max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{border-radius:50px;width:120%;height:100%;object-fit:cover;}.details{margin:3rem;font-size:2rem;margin-left:22%;text-align:center;}p{margin-top:1%;font-style:italic;}button{border-radius:25px;background:whitesmoke;margin-top:95%;cursor:pointer;font-size:150%;inline-size:90%;}h3{margin-top:25%;}.addToCart{margin-top:-25%;button:hover{color:white;background-color:#3399ff;}}"], function (props) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SingleItemStyles, {
          ...
          __self: this
        }, "Crafted and Sold by ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pStyle", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 107
          },
...
//# sourceMappingURL=item.js.499659fc8bdf83fd085e.hot-update.js.map