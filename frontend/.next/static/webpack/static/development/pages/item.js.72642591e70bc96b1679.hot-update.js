...
/* harmony import */ var _RemoveOne__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./RemoveOne */ "./components/RemoveOne.js");
...
})(["border-radius:50px;max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{border-radius:50px;width:110%;height:100%;object-fit:cover;}.details{margin:3rem;font-size:2rem;margin-left:22%;text-align:center;}p{em{color:#3399ff;margin-top:0;}margin-top:20%;}button{border-radius:25px;background:whitesmoke;margin-top:10%;cursor:pointer;font-size:150%;inline-size:90%;:hover{color:white;background-color:#3399ff;}}h3{margin-top:25%;}"], function (props) {
...
})(["font-style:italic;"]); // const pStyle = {
//   color: '#3399ff',
// };
...
//# sourceMappingURL=item.js.72642591e70bc96b1679.hot-update.js.map