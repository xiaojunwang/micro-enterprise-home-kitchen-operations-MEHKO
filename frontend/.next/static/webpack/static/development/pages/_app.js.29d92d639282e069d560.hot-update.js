...
})(["padding:20px;position:relative;background:white;position:fixed;height:100%;top:0;right:0;width:35%;min-width:500px;bottom:0;transform:translateX(100%);transition:all 0.3s;box-shadow:0 0 10px 3px rgba(0,0,0,0.2);z-index:5;display:grid;grid-template-rows:auto 1fr auto;", ";header{border-bottom:5px solid ", ";margin-bottom:1rem;padding-bottom:2rem;p{text-align:right;}}footer{border-top:10px double ", ";margin-top:2rem;padding-top:2rem;display:flex;grid-template-columns:auto auto;align-items:center;font-size:3rem;font-weight:900;p{flex:1 21%;margin:0;}}ul{margin:0;padding:0;list-style:none;overflow:scroll;}"], function (props) {
...
//# sourceMappingURL=_app.js.29d92d639282e069d560.hot-update.js.map