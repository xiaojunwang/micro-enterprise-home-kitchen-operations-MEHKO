...
function (_Component) {
  ...
  function SingleItem() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SingleItem)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "CLOSE_CART_MUTATION", function () {
      return graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(_templateObject2());
    });
...
//# sourceMappingURL=item.js.4aa01786ff1b87989c69.hot-update.js.map