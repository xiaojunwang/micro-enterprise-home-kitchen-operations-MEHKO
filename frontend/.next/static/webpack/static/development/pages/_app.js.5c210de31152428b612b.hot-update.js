...
})(["padding:0.7rem 0;border-bottom:1px solid ", ";display:grid;align-items:center;grid-template-columns:auto 1fr auto;img{border-radius:25px;margin-right:10px;}h3{margin-left:5%;}p{margin-left:5%;color:gray;}.delete{grid-column-end:five;}.remove{justify-self:start;&:hover{color:", ";cursor:pointer;}}.add{justify-self:start;&:hover{color:blue;cursor:pointer;}}"], function (props) {
...
//# sourceMappingURL=_app.js.5c210de31152428b612b.hot-update.js.map