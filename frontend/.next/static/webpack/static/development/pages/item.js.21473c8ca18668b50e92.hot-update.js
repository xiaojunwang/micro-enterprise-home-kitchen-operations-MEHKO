...
})(["border-radius:50px;max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{border-radius:50px;width:120%;height:100%;object-fit:cover;}.details{margin:3rem;font-size:2rem;margin-left:22%;text-align:center;}p{margin-top:25%;}button{margin-top:100%;cursor:pointer;block-size:10%;tab-size:10%10ch;}"], function (props) {
...
//# sourceMappingURL=item.js.21473c8ca18668b50e92.hot-update.js.map