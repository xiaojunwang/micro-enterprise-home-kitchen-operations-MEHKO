...
})(["padding:0.7rem 0;border-bottom:1px solid ", ";display:grid;align-items:center;grid-template-columns:auto 1fr auto;img{border-radius:25px;margin-right:10px;}h3{margin-left:5%;}p{margin-left:5%;color:gray;}.delete{grid-column-end:five;}.addremove{justify-self:start;}button{cursor:pointer;.remove{&:hover{color:", ";}}.add{&:hover{color:blue;}}}"], function (props) {
...
//# sourceMappingURL=_app.js.b68ca2b85fbf8a5ca40e.hot-update.js.map