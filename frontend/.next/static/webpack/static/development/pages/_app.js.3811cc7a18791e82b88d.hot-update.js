...
})(["padding:0.7rem 0;border-bottom:1px solid ", ";display:grid;align-items:center;grid-template-columns:auto 1fr auto;img{border-radius:25px;margin-right:10px;}h3{margin-left:5%;}p{margin-left:5%;color:gray;}.delete{grid-column-end:five;}.one{justify-self:center;grid-column-end:two;}.addremove:hover{background-color:blue;}button{cursor:pointer;}"], function (props) {
...
//# sourceMappingURL=_app.js.3811cc7a18791e82b88d.hot-update.js.map